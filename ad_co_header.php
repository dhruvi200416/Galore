...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="ad_co_dashboard.php"><i class="bi bi-speedometer2"></i> Dashboard</a>
        <a href="ad_co_profile.php"><i class="fas fa-user-tie"></i> Profile</a>
        ...
        <div class="dropdown-container">
            ...
            <div class="dropdown-menu-custom">
                <a href="ad_co_dash.php"><i class="bi bi-image-fill"></i> Dashboard Header</a>
                <a href="ad_co_sch.php"><i class="bi bi-info-circle-fill"></i> School Header</a>
                <a href="ad_co_part.php"><i class="bi bi-calendar2-event-fill"></i> Participations Header</a>
                <a href="ad_co_announce.php"><i class="bi bi-house-add-fill"></i> Announcements Header</a>
            </div>
        </div>

        <a href="ad_co_team.php"><i class="bi bi-house-add-fill"></i> Teams</a>
        <a href="ad_co_Participations.php"><i class="bi bi-people-fill"></i> Participations</a>
        <a href="ad_co_announcements.php"><i class="bi bi-house-add-fill"></i> Announcements</a>
...
<script>
    ...
    function setActiveMenuItem() {
        // Get current page filename (e.g., "ad_co_dashboard.php")
        const currentPage = window.location.pathname.split('/').pop();
        
        // Also handle cases where there might be query parameters
        ...
        allLinks.forEach(link => {
            ...
            if (href) {
                // Remove query parameters from href if any
        ...
        // If exact match found, highlight it and open its parent dropdown
        if (exactMatchLink) {
            exactMatchLink.classList.add('active');
            
            // Open the parent dropdown of the exact match
            const parentDropdown = exactMatchLink.closest('.dropdown-container');
            if (parentDropdown) {
        ...
        // If no exact match, try with .php extension comparison
        allLinks.forEach(link => {
            const href = link.getAttribute('href');
            if (href && !exactMatchLink) {
                // Compare with .php
                if (href === currentPageWithoutParams || 
                    href + '.php' === currentPageWithoutParams ||
                    href === currentPageWithoutParams + '.php') {
                    exactMatchLink = link;
                }
            }
        });
