...
<body>
    ...
    <main class="main-content">
        ...
        <div class="top-bar d-flex justify-content-between align-items-center flex-wrap gap-3" id="topBar">
            <h1 class="mb-0">Registration Header Management</h1>
        ...
        <div class="add-user-form-container" id="addHeaderForm" style="display:none;">
            <h3 class="form-title" id="formTitleText">Add Registration Header</h3>
        ...
        <div class="data-table-container">
            ...
            <div class="table-header" id="tableHeader">
                <h2 class="mb-0">Registration Header Data</h2>
            ...
            <div class="modal-content" style="border-radius:18px;border-top:6px solid var(--galore-red);">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            <strong>Hero Title:</strong> <span id="v_hero_title"></span>
                        </div>
                        <div class="col-12 mb-3">
                            <strong>Hero Subtitle:</strong> <span id="v_hero_subtitle"></span>
                        </div>
                        <div class="col-12 mb-3">
                            <strong>Form Title:</strong> <span id="v_form_title"></span>
                        </div>
                        <div class="col-12 mb-3">
                            <strong>Date:</strong> <span id="v_date"></span>
                        </div>
                        <div class="col-12 mb-3">
                            <strong>Footer Note:</strong> <span id="v_footer_note"></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $("#openFormBtn").click(() => {
            formTitleText.text("Add Registration Header");
            editId = null;
            $("#edit_id").val("");
            $("#headerForm")[0].reset();
            ...
            if (paginatedData.length === 0) {
                ...
                paginatedData.forEach(h => {
                    tbody.append(`
                        <tr>
                            <td>${h.id}</td>
                            <td>${escapeHtml(h.hero_title)}</td>
                            <td>${escapeHtml(h.form_title)}</td>
                            <td>
        ...
        function editHeader(id) {
            ...
            if (h) {
                editId = id;
                formTitleText.text("Edit Registration Header");
                $("#edit_id").val(id);
