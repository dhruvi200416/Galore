...
// Create c_sch table
$sch_table = "CREATE TABLE IF NOT EXISTS c_sch (
...
if (mysqli_query($con, $sch_table)) {
    // echo "Table 'c_sch' created successfully";
} else {
...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['edit_id']) && !empty($_POST['edit_id'])) {
        ...
        // Insert new school
        $insert_query = "INSERT INTO c_sch (hero_title, hero_subtitle) 
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = "DELETE FROM c_sch WHERE id = '$delete_id'";
...
$schoolData = [];
$select_query = "SELECT * FROM c_sch ORDER BY id ASC";
