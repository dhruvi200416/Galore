<?php
include 'ad_cultural_handler.php';
?>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="add-sport-form-container" id="addSportForm" style="display:none;">
            ...
            <form id="sportForm" method="POST" action="">
                ...
                <div class="galore-input-group">
                    ...
                    <input type="text" name="hero_title" class="galore-input" data-validation="required min" data-min="2" data-max="200">
                ...
                <div class="galore-input-group">
                    ...
                    <input type="text" name="hero_subtitle" class="galore-input" data-validation="required min" data-min="2" data-max="200">
                ...
                <div class="galore-input-group">
                    ...
                    <input type="text" name="section_title" class="galore-input" data-validation="required min" data-min="2" data-max="200">
                ...
                <div class="galore-input-group">
                    ...
                    <input type="text" name="section_subtitle" class="galore-input" data-validation="required min" data-min="2" data-max="200">
                ...
                <div class="galore-input-group">
                    ...
                    <textarea name="note_text" class="galore-textarea" data-validation="required min" data-min="2" data-max="500"></textarea>
        ...
        <div class="add-event-form-container" id="addEventForm" style="display:none;">
            ...
            <form id="eventForm" method="POST" action="">
                ...
                <div class="galore-input-group">
                    ...
                    <input type="text" name="event_name" class="galore-input" data-validation="required min" data-min="2" data-max="200" placeholder="e.g., 🎤 Solo Singing">
                    <span id="event_name_error" class="error-message"></span>
                </div>

                <div class="galore-input-group">
                    <label class="galore-label">Description <span class="text-danger">*</span></label>
                    <textarea name="description" class="galore-textarea" data-validation="required min" data-min="2" data-max="500"></textarea>
        ...
        <!-- FIRST TABLE: CULTURAL HEADER -->
        <div class="data-table-container">

            <div class="table-header" id="sportTableHeader">
                <h2 class="mb-0">Cultural Event Data</h2>

                <div class="search-box" id="sportSearchBox">
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th>Hero Title</th>
                            <th>Hero Subtitle</th>
                            <th id="sportActionsHeader">Actions</th>
                        </tr>
                    </thead>
        ...
        <div class="data-table-container">
            ...
            <div class="table-header" id="eventTableHeader">
                <h2 class="mb-0">Event Data</h2>

                <div class="search-box" id="eventSearchBox">
                    <i class="bi bi-search"></i>
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th>Description</th>
                            <th>Status</th>
                            <th id="eventActionsHeader">Actions</th>
                        </tr>
                    </thead>
    ...
    <!-- CULTURAL EVENT VIEW MODAL (ONLY X BUTTON) -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:18px;border-top:6px solid var(--galore-red);">
                <div class="modal-header text-white" style="background:var(--galore-red);">
                    <h5 class="modal-title fw-bold">Cultural Event Full Details</h5>
    ...
    <!-- EVENT VIEW MODAL (ONLY X BUTTON) -->
    ...
    <script>
        ...
        let editId = null; // Track editing row for cultural header
        ...
        // Open cultural header form button
        $("#openFormBtn").click(() => {
            formTitleText.text("Add Cultural Event");
            editId = null;
            $("#edit_id").val("");
            $("#sportForm")[0].reset();
        ...
        // Cancel cultural header form button
        $("#cancelForm").click(() => {
            addSportForm.slideUp();
            $("#sportForm")[0].reset();
            $("#edit_id").val("");
        ...
        // Render cultural header table with pagination
        ...
        // Delete cultural header
        function deleteSport(id) {
            if (confirm("Are you sure you want to delete this cultural event entry?")) {
        ...
        // Edit cultural header
        function editSport(id) {
            editId = id;
            const s = sportData.find(x => x.id == id);
            formTitleText.text("Edit Cultural Event");
            $("#edit_id").val(id);
        ...
        // Search functionality for cultural header
        ...
        $(document).ready(function() {
            function validateInput(input) {
                ...
                if (validationType) {
                    ...
                    if (value !== "" && !errorMessage) {
                        ...
                        // Add validation - MODIFIED TO ACCEPT EMOJIS AND SPECIAL CHARACTERS
            ...
            // Cultural header form submission with validation
