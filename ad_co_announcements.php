<?php
// At the very top of ad_co_announcements.php
...
include 'ad_co_announcements_handler.php';
?>
...
<body>
        ...
        <div class="add-form-container" id="addAnnouncementForm">
            ...
            <form id="announcementForm" method="POST" action="">
                ...
                <div class="form-grid">
                    ...
                    <div class="galore-input-group full-width">
                        <label class="galore-label">Emails (Comma-separated) <span class="text-danger">*</span></label>
                        <textarea name="emails" class="galore-textarea" rows="3" data-validation="required min" data-min="5" data-max="1000" placeholder="Enter email addresses separated by commas"></textarea>
                        <span id="emails_error" class="error-message"></span>
                    </div>

                    <div class="galore-input-group full-width">
                        <label class="galore-label">Content <span class="text-danger">*</span></label>
                        <textarea name="content" class="galore-textarea" rows="6" data-validation="required min" data-min="10" data-max="5000"></textarea>
        ...
        <div class="data-table-container">
            <div class="table-header">
                ...
                <div class="search-box">
                    ...
                    <input type="text" id="searchAnnouncementInput" placeholder="Search by title or content...">
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Announcement Full Details</h5>
                ...
                <div class="modal-body">
                    <div class="detail-grid">
                        ...
                        <div class="detail-item full-width">
                            <div class="detail-label">Recipients (Emails)</div>
                            <div class="detail-value" id="view_emails" style="white-space: pre-wrap;"></div>
                        </div>
                        <div class="detail-item full-width">
    ...
    <script>
        ...
        function renderAnnouncementTable() {
            ...
            if (paginatedData.length === 0) {
                ...
                paginatedData.forEach(item => {
                    ...
                    let emailCount = item.emails ? item.emails.split(',').length : 0;
                    let emailDisplay = emailCount > 0 ? `${emailCount} recipient(s)` : 'No recipients';
        ...
        function viewAnnouncement(id) {
            ...
            let emailsHtml = '';
            if (item.emails) {
                let emailArray = item.emails.split(',');
                emailArray.forEach(email => {
                    emailsHtml += `<div><i class="bi bi-envelope me-2"></i>${email.trim()}</div>`;
                });
                $("#view_emails").html(emailsHtml);
            } else {
                $("#view_emails").html('<div class="text-muted">No emails specified</div>');
            }
        ...
        function editAnnouncement(id) {
            ...
            $('textarea[name="emails"]').val(item.emails || '');
        ...
        $("#announcementForm").on("submit", function(e) {
            ...
            // Additional validation for emails format
            let emailsValue = $('textarea[name="emails"]').val().trim();
            if (emailsValue) {
                let emailList = emailsValue.split(',');
                let invalidEmails = [];
                ...
                if (invalidEmails.length > 0) {
                    $("#emails_error").text("Invalid email format(s): " + invalidEmails.join(', '));
                    $('textarea[name="emails"]').addClass("is-invalid").removeClass("is-valid");
                    isValid = false;
                    if (!firstInvalidField) {
                        firstInvalidField = $('textarea[name="emails"]')[0];
                    }
                }
            }
