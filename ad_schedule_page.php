<?php
include 'ad_schedule_page_handler.php';
?>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="top-bar d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3" id="topBar">
            <h1 class="mb-0">Schedule Page Management</h1>
            <!-- <button class="btn-add-user" id="openFormBtn">
                <i class="bi bi-plus-circle"></i> Add Schedule Page
            </button> -->
        </div>

        <!-- FORM -->
        <div class="add-user-form-container" id="addScheduleForm" style="display:none;">
            <h3 class="form-title" id="formTitleText">Add Schedule Page</h3>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:18px;border-top:6px solid var(--galore-red);">
                <div class="modal-header text-white" style="background:var(--galore-red);">
                    <h5 class="modal-title fw-bold">Schedule Page Full Details</h5>
    ...
    <script>
        // Use PHP to pass database schedules to JavaScript
        let scheduleData = <?php echo json_encode($scheduleData); ?>;

        // If no schedules in database, use empty array
        ...
        // Open form button
        $("#openFormBtn").click(() => {
            formTitleText.text("Add Schedule Page");
            editId = null;
            $("#edit_id").val("");
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex flex-column flex-sm-row gap-2 gap-sm-2">
                                <button class="action-btn btn-view" onclick="viewSchedule(${s.id})">View</button>
                                <button class="action-btn btn-edit" onclick="editSchedule(${s.id})">Edit</button>
                                <button class="action-btn btn-delete" onclick="deleteSchedule(${s.id})">Delete</button>
                            </div>
                        </td>
                    </tr>`);
                });
        ...
        function deleteSchedule(id) {
            if (confirm("Are you sure you want to delete this schedule page?")) {
        ...
        function editSchedule(id) {
            ...
            formTitleText.text("Edit Schedule Page");
            $("#edit_id").val(id);
        ...
        $(document).ready(function() {
            ...
            // Schedule form submission with validation
