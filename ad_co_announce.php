<?php
include 'ad_co_announce_handler.php';
?>
...
<head>
    <meta charset="UTF-8">
    <title>Coordinator Dashboard | RKU Galore - Announcement Page</title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="top-bar d-flex justify-content-between align-items-center flex-wrap gap-3" id="topBar">
            <h1 id="pageTitle" class="mb-0">Announcement Page Management</h1>
            <!-- <button class="btn-add-gallery" id="openFormBtn">
                <i class="bi bi-plus-circle"></i> Add Announcement Page
            </button> -->
        </div>

        <!-- FORM -->
        <div class="add-gallery-form-container" id="addGalleryForm" style="display:none;">
            <h3 class="form-title" id="formTitleText">Add Announcement Page</h3>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:18px;border-top:6px solid var(--galore-red);">
                <div class="modal-header text-white" style="background:var(--galore-red);">
                    <h5 class="modal-title fw-bold">Announcement Page Full Details</h5>
    ...
    <script>
        // Use PHP to pass database announcements to JavaScript
        let galleryData = <?php echo json_encode($announceData); ?>;

        // If no announcements in database, use empty array
        ...
        // Open form button
        $("#openFormBtn").click(() => {
            formTitleText.text("Add Announcement Page");
            editId = null;
            $("#edit_id").val("");
            $("#galleryForm")[0].reset();
        ...
        function editGallery(id) {
            ...
            formTitleText.text("Edit Announcement Page");
            $("#edit_id").val(id);
