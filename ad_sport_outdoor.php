<?php
include 'ad_sport_outdoor_handler.php';
?>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="add-sport-form-container" id="addSportForm" style="display:none;">
            <h3 class="form-title" id="formTitleText">Add Sport & Outdoor</h3>
        ...
        <div class="add-event-form-container" id="addEventForm" style="display:none;">
            ...
            <form id="eventForm" method="POST" action="">
                ...
                <div class="galore-input-group">
                    ...
                    <input type="text" name="event_name" class="galore-input" data-validation="required min" data-min="3" data-max="100" placeholder="e.g., 🤾 Dodgeball">
                    <span id="event_name_error" class="error-message"></span>
                </div>

                <div class="galore-input-group">
                    <label class="galore-label">Description <span class="text-danger">*</span></label>
                    <textarea name="description" class="galore-textarea" data-validation="required min" data-min="10" data-max="500"></textarea>
        ...
        <!-- FIRST TABLE: SPORT & OUTDOOR -->
        <div class="data-table-container">

            <div class="table-header">
                <h2>Sport & Outdoor Data</h2>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:18px;border-top:6px solid var(--galore-red);">
                <div class="modal-header text-white" style="background:var(--galore-red);">
                    <h5 class="modal-title fw-bold">Sport & Outdoor Full Details</h5>
    ...
    <script>
        ...
        $("#openFormBtn").click(() => {
            formTitleText.text("Add Sport & Outdoor");
            editId = null;
            $("#edit_id").val("");
            $("#sportForm")[0].reset();
        ...
        function renderSportTable() {
            ...
            const filteredData = sportData.filter(s =>
                ...
                (s.section_title && s.section_title.toLowerCase().includes(searchValue)) ||
                (s.section_subtitle && s.section_subtitle.toLowerCase().includes(searchValue))
            );
        ...
        function deleteSport(id) {
            if (confirm("Are you sure you want to delete this sport & outdoor entry?")) {
        ...
        function editSport(id) {
            ...
            formTitleText.text("Edit Sport & Outdoor");
            $("#edit_id").val(id);
        ...
        // Edit event - UPDATED to handle form without status
